...
type projectSummaryOut struct {
	...
	// years; ReleasedHours is the unplanned budget an INACTIVE project gives up;
	// AvailableBudgetHours is budgetHours minus both.
	...
	ReleasedHours        float64 `json:"releasedHours"`
