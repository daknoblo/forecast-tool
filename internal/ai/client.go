...
- projects: Liste von { id, assignmentId, name, budgetHours, color, active, fiscalYear, system? }. id = kurze eindeutige Kennung; assignmentId = externe Assignment-ID als String (z. B. "5641245"), bei regulären Projekten Pflicht; color = Hex (#rrggbb); fiscalYear = das Anker-Jahr (FY 27 => 2027). Ein Projekt mit "system": "vacation" ist das automatisch verwaltete Urlaubsprojekt (id "vacation-<jahr>", Name "Urlaub", ohne assignmentId): NICHT löschen, umbenennen oder sein budgetHours ändern; seine Stunden zählen nicht aufs Jahresziel. Reguläre Projekte haben kein system-Feld.
